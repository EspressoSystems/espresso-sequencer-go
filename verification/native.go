...
/*
#cgo amd64 LDFLAGS: -L${SRCDIR}/../target/lib/ -lespresso_crypto_helper-x86_64-unknown-linux-gnu -lm
#cgo arm64 LDFLAGS: -L${SRCDIR}/../target/lib/ -lespresso_crypto_helper-aarch64-unknown-linux-gnu -lm
#include <stdbool.h>
#include <stdint.h>
