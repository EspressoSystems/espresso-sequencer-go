...
#cgo linux,amd64 LDFLAGS: -L${SRCDIR}/../target/lib/ -lespresso_crypto_helper-x86_64-unknown-linux-musl -lm
#cgo linux,arm64 LDFLAGS: -L${SRCDIR}/../target/lib/ -lespresso_crypto_helper-aarch64-unknown-linux-musl -lm
#include <stdbool.h>
#include <stdint.h>
